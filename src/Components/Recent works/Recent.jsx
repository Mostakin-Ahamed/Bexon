    ...
    return (
        <div className='mt-20 mb-20'>
            {/* <div className='lg:ml-64'>
                <svg xmlns="http://www.w3.org/2000/svg" height="2" viewBox="0 0 1170 2" fill="none">
            ...
            <div className="mt-20 mr-5 lg:mt-40 lg:ml-64">
                ...
                <img className="h-[600px] lg:w-[1470px] object-cover ml-2 mr-4" src="/public/recent.png" alt="" />
                ...
                <div className='lg:flex justify-between lg:mr-40'>
                    <div>
                        <img className='w-[700px] h-[700px] ml-2 mr-4 lg:ml-0 lg:mr-0 object-cover' src="/public/image1.png" alt="" />
                    ...
                    <div>
                        <img className='w-[700px] h-[700px] ml-2 mr-4 lg:ml-0 lg:mr-0 object-cover' src="/public/image2.png" alt="" />
